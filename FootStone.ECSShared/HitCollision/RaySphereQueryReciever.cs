...
[DisableAutoCreation]
public class RaySphereQueryReciever : ComponentSystem
{
	public struct Query
	{
...
//		GameDebug.Assert(queryData.state == QueryData.State.Idle);
	...
	void UpdateBatch(QueryBatch queryBatch)
	{
        ...
        var hitCollEntityArray = m_colliderGroup.ToEntityArray(Allocator.Persistent);
		var hitCollDataArray = m_colliderGroup.ToComponentDataArray<HitCollisionData>(Allocator.Persistent);
