...
namespace FootStone.ECS
{
    ...
    //            GameDebug.Log("HandleReplicatedEntityDataDespawn.Initialize entity:" + entity + " type:" + typeId +
    //                          " id:" + spawned.id);
    //    }
    ...
    //    {
    //        if (ReplicatedEntityModuleServer.m_showInfo.IntValue > 0)
    //            GameDebug.Log("HandleReplicatedEntityDataDespawn.Deinitialize entity:" + entity + " id:" +
    //                          component.id);
    ...
    public class ReplicatedEntityServer
    {
        [ConfigVar(Name = "server.replicatedsysteminfo", DefaultValue = "0",
            Description = "Show replicated system info")]
        public static ConfigVar m_showInfo;

        public ReplicatedEntityServer(GameWorld world, BundledResourceManager resourceSystem,
            NetworkServer network)
        {
            ...
            //m_handleDataDespawn = m_world.GetECSWorld().CreateManager<HandleReplicatedEntityDataDespawn>(m_world,
            //    network,
            //    m_entityCollection);
